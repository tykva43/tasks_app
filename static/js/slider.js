...
const SELECTOR_ITEM = '.slider_item';
const SELECTOR_ITEMS = '.slider_items';
const SELECTOR_WRAPPER = '.slider_wrapper';
const SELECTOR_PREV = '.slider_control[data-slide="prev"]';
const SELECTOR_NEXT = '.slider_control[data-slide="next"]';
const SELECTOR_INDICATOR = '.slider_indicators>li';

const SLIDER_TRANSITION_OFF = 'slider_disable-transition';
const CLASS_CONTROL = 'slider_control';
const CLASS_CONTROL_HIDE = 'slider_control_hide';
const CLASS_ITEM_ACTIVE = 'slider_item_active';
